...
export default function CardItem2({ card }: CardItem2Props) {
  ...
  const handleRatingChange = (event: React.SyntheticEvent, rating: number | null) => setRating(rating)
  ...
  return (
    <Card>
      ...
      {/* Quick View Dialog */}
      <CardItemQuickViewDialog dialogOpen={quickViewDialogOpen} toggleDialog={toggleQuickViewDialog} card={card} />
